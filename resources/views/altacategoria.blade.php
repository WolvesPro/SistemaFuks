...
<div class="main-content">
			...
			<form action = '{{route('guardacategoria')}}' method = 'POST' enctype='multipart/form-data'>
...
@endif	
			    <div class="form-group">
					<label for="id" class=" form-control-label">Id:</label>
						<input type="text" id="id" name="id_categoria" value="{{$idcas}}" readonly ='readonly' placeholder="Id" class="form-control">
				</div>
				{{csrf_field()}}
...
@endif	
				...
				<div class="form-group">
					<label for="nombrec" class=" form-control-label">Nombre de Categoría:</label>
						<input type="text" id="nombrec" name="nomb_categoria" value="{{old('nomb_categoria')}}" placeholder="Nombre de Categoría" class="form-control">
				</div>
