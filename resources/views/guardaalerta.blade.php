                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                <div class="card">
                                    <div class="card-header">Modifica Alertas</div>
										 <div class="card-body">
										 <div class="card-title">
                                            <h3 class="text-center title-2">Datos de la Alerta</h3>
                                        </div>
			<form action = "{{route('editaale')}}" method = 'POST' enctype='multipart/form-data'>
...
@endif	
			    <div class="form-group">
					<label for="id" class=" form-control-label">Id Alerta:</label>
						<input type="text" id="id" name="id_alerta" value="{{$alerta->id_alerta}}" readonly ='readonly' placeholder="Id" class="form-control">
				</div>
...
@endif
				<div class="form-group">
					<label for="nombrearealerta" class=" form-control-label">Nombre de Alerta:</label>
						<input type="text" id="nombrearealerta" name="nombre_alerta" value="{{$alerta->nombre_alerta}}" placeholder="Nombre de Alerta" class="form-control">
				</div>
...
@endif
				<div class="form-group">
					<label for="tipo" class=" form-control-label">Tipo de Alerta:</label>
						<input type="text" id="tipo" name="tipo" value="{{$alerta->tipo}}" placeholder="Tipo de Alerta" class="form-control">
				</div>
