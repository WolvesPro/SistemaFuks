...
@endif	
			    <div class="form-group">
					<label for="id" class=" form-control-label">Nombre:</label>
						<input type="text" id="id" name="id_prov" value="{{$idps}}" readonly ='readonly' placeholder="Id" class="form-control">
				</div>
			{{csrf_field()}}
...
@endif	
				<div class="form-group">
					<label for="nombre" class=" form-control-label">Nombre:</label>
						<input type="text" id="nombre" name="nomb_prov" value="{{old('nomb_prov')}}" placeholder="Nombre:" class="form-control">
				</div>
...
@endif	
				<div class="form-group">
					<label for="rs" class=" form-control-label">Razón Social:</label>
						<input type="text" id="rs" name="razon_social" value="{{old('razon_social')}}" placeholder="Razón Social:" class="form-control">
				</div>
				{{csrf_field()}}
...
@endif
				<div class="form-group">
					<label for="sc" class=" form-control-label">Sector Comercial:</label>
						<input type="text" id="sc" name="sector_comercial" value="{{old('sector_comercial')}}" placeholder="Sector Comercial" class="form-control">
				</div>
				{{csrf_field()}}
