...
<div class="main-content">
			...
			<form action = "{{route('editaproducto')}}" method = 'POST' enctype='multipart/form-data'>
				{{csrf_field()}}
...
@endif	
			    <div class="form-group">
					<label for="id" class=" form-control-label">Id:</label>
						<input type="text" id="id" name="id_prod" value="{{$producto->id_prod}}" readonly ='readonly' placeholder="Id" class="form-control">
				</div>
...
@endif
				...
				<div class="form-group">
					<label for="nombrep" class=" form-control-label">Nombre de Producto:</label>
						<input type="text" id="nombrep" name="nomb_prod" value="{{$producto->nomb_prod}}" placeholder="Nombre de Producto" class="form-control">
				</div>
...
@endif	
				...
				<div class="form-group">
					<label for="precio" class=" form-control-label">Precio:</label>
						<input type="text" id="precio" name="precio" value="{{$producto->precio}}" placeholder="Precio" class="form-control">
				</div>
				{{csrf_field()}}
...
@endif	
				...
				<div class="form-group">
					<label for="existencia" class=" form-control-label">Existencia:</label>
						<input type="text" id="existencia" name="existencia" value="{{$producto->existencia}}" placeholder="Existencia" class="form-control">
...
@endif	
				<div class="form-group">
					<label for="precio" class=" form-control-label">Descripcion:</label>
						<input type="text" id="precio" name="descripcion" value="{{$producto->descripcion}}" placeholder="Precio" class="form-control">
				</div>
				<div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select name="id_prov" id="cliente" class="form-control">
							<option value='{{$id_prov}}'>{{$proveedor}}</option>
                            @foreach($demasprovedores as $provee)
				...
				<div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select name="id_cliente" id="proveedor" class="form-control">
                            ...
                            @foreach($demasclientes as $clien)
