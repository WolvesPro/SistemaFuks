                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                <div class="card">
                                    <div class="card-header">Alta Área</div>
										 <div class="card-body">
										 <div class="card-title">
                                            <h3 class="text-center title-2">Datos del Área</h3>
                                        </div>
			<form action = '{{route('guardaarea')}}' method = 'POST' enctype='multipart/form-data'>
...
@endif	
			    <div class="form-group">
					<label for="id" class=" form-control-label">Id:</label>
						<input type="text" id="id" name="id_area" value="{{$idars}}" readonly ='readonly' placeholder="Id" class="form-control">
				</div>
...
@endif	
				...
				<div class="form-group">
					<label for="nombrearea" class=" form-control-label">Nombre de Área:</label>
						<input type="text" id="nombrearea" name="nomb_area" value="{{old('nomb_area')}}" placeholder="Nombre de Área" class="form-control">
				</div>
...
@endif	
				<div class="form-group">
					<label for="ubicacion" class=" form-control-label">Ubicación:</label>
						<input type="text" id="ubicacion" name="ubicacion" value="{{old('ubicacion')}}" placeholder="Ubicación" class="form-control">
				</div>
				<div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select name="id_ma" id="maquinaria" class="form-control">
                            ...
                            <option value='{{$maqui->id_ma}}'>{{$maqui->nombre_ma}}</option>
                            @endforeach
                        </select>
                    </div>		
                </div>
